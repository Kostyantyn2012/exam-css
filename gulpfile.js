...
let gulp              = require('gulp'),
    ...
    gulp.task('generate-favicon', function(done) {
      realFavicon.generateFavicon({
        masterPicture: 'src/master_favicon.png',           //путь к вашей основной картинке. Например, assets/images/master_picture.png.
    ...
    gulp.task('inject-favicon-markups', function() {
      return gulp.src([ 'src/index.html','build/index.html' ]) //списком HTML-файлов, куда добавить разметку favicon. Например, ['dist/*.html', 'dist/misc/*.html'].
    ...
    gulp.task('default', gulp.parallel('browser-sync', 'watch', 'scss', 'style',  'minjs', 'html', 'cleanfonts', 'cleanimg')) //запускает все перечисленные задачи разом